...
function waitingFor(screen){
 ...
 if(!received)
  return waitingPanel('Waiting for supplier responses',
   ...
   next('Collect the responses first.','Open response extraction','responses'));
